...
'Gender_Cat','University_Degree_Cat','Profession_Cat','Country_Cat']]
...
#dataset2 refers to the file wihout labels. Used to test our trained model on.
...
X1 = dataset2[['Year of Record','Age','Size of City',
'Gender_Cat','University_Degree_Cat',
'Profession_Cat','Country_Cat']]
...
df = pd.DataFrame({'Predict':Y_pred.flatten()})
print(df.to_csv("test7.csv"))